...
public class SexDamage_Fuck extends AbstractLupaDamage {
    public static final String ID = DataManager.MakeTextID(SexDamage_Fuck.class.getSimpleName());
    private final static int OnlyDealDamage = 1;

    public SexDamage_Fuck() {
        super(ID);
    }
