...
public class PregnantBlock_loop extends PregnantBlock {
    private final ArrayList<AbstractPower> sealPower;
    private final AbstractCreature sealCreature;

    public PregnantBlock_loop(ArrayList<AbstractPower> sealPower, AbstractCreature sealCreature) {
        super();
    ...
    public AbstractBlockModifier makeCopy() {
        return new PregnantBlock_loop(this.sealPower, this.sealCreature);
    }
}