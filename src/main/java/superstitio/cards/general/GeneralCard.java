...
public abstract class GeneralCard extends SuperstitioCard implements IsMasoCard, IsLupaCard {
    /**
     * 普通的方法
     *
     * @param id         卡牌ID
     ...
     */
    public GeneralCard(String id, CardType cardType, int cost, CardRarity cardRarity, CardTarget cardTarget) {
     ...
     * 当需要自定义卡牌存储的二级目录名时
     */
    public GeneralCard(String id, CardType cardType, int cost, CardRarity cardRarity, CardTarget cardTarget, String imgSubFolder) {
        this(id, cardType, cost, cardRarity, cardTarget, DataManager.SPTT_DATA.GeneralEnums.GENERAL_CARD, imgSubFolder);
    }

    public GeneralCard(String id, CardType cardType, int cost, CardRarity cardRarity, CardTarget cardTarget, CardColor cardColor) {
