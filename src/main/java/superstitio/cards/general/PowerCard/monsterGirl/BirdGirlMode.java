...
public class BirdGirlMode extends AbstractTempCard {
    public static final String ID = DataManager.MakeTextID(BirdGirlMode.class);
    ...
    public void onChoseThisOption() {
        addToBot_applyPower(new BirdGirlModePower(this.magicNumber));
    }
    ...
    public static class BirdGirlModePower extends EasyBuildAbstractPowerForPowerCard {
        public BirdGirlModePower(int amount) {
            super(amount);
        }

        @Override
        protected SuperstitioCard makePowerCard() {
            return new BirdGirlMode();
        }
    ...
    public static class PlayerFlightPower extends FlightPower {
