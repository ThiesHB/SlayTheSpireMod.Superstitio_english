package superstitio.cards.lupa.AttackCard.hand;
...
public class Job_Hand_BaseCard extends AbstractLupaCard_FuckJob implements GoSomewhereElseAfterUse {
    public static final String ID = DataManager.MakeTextID(Job_Hand_BaseCard.class.getSimpleName());
