...
abstract class CardOrb(card: AbstractCard, cardGroupReturnAfterEvoke: CardGroup?, OrbCounter: Int) : AbstractOrb() {
...
//        tryUpdateOrbCounterInCard(cardRawDescriptionWillShow, OrbCounter);
    ...
    fun addToBot_HangCard() {
        ...
        AutoDoneInstantAction.addToBotAbstract(VoidSupplier(AbstractDungeon::onModifyPower))
    }
    ...
    fun onRemove() {
        ...
        onRemoveCard()
        if (afterEvokeConsumer != null) afterEvokeConsumer!!.accept(this)
    }
    ...
    protected fun updateIfFocusOnMonster() {
        val target: AbstractCreature = hoveredMonster.orElse(null)
    ...
    private fun tryUpdateOrbCounterInCard(cardRawDescriptionWillShow: String?, NewOrbCounter: Int) {
        if (cardRawDescriptionWillShow == null || cardRawDescriptionWillShow.isEmpty()) return
    ...
    override fun update() {
        ...
        this.evokeAmount = orbCounter - 1
        this.passiveAmount = orbCounter
    }
    ...
    companion object {
        ...
        val hoveredMonster: Optional<AbstractMonster>
            get() {
                val hoveredMonster = ReflectionHacks.getPrivate<AbstractMonster>(
                    AbstractDungeon.player,
                    AbstractPlayer::class.java,
                    "hoveredMonster"
                )
