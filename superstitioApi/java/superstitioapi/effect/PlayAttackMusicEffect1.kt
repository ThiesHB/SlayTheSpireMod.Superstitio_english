    ...
    companion object {
        private fun playSound(effect: AttackEffect) {
            when (effect) {
                ...
                AttackEffect.SLASH_HEAVY -> CardCrawlGame.sound.play("ATTACK_HEAVY")
                AttackEffect.BLUNT_LIGHT -> CardCrawlGame.sound.play("BLUNT_FAST")
                AttackEffect.BLUNT_HEAVY -> CardCrawlGame.sound.play("BLUNT_HEAVY")
                AttackEffect.FIRE -> CardCrawlGame.sound.play("ATTACK_FIRE")
                AttackEffect.POISON -> CardCrawlGame.sound.play("ATTACK_POISON")
                AttackEffect.NONE -> {}
