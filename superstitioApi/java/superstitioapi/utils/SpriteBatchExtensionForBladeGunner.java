...
public class SpriteBatchExtensionForBladeGunner {
    ...
    private static void drawProgressRightTop(SpriteBatch sb, TextureRegion region, float x, float y, float width, float height, float startDegree,
        ...
        float[] vertices = ReflectionHacks.getPrivate(sb, SpriteBatch.class, "vertices");
        ...
        float cx = x + width / 2;
        float cy = y + height / 2;
        float cu = (region.getU() + region.getU2()) / 2;
        float cv = (region.getV() + region.getV2()) / 2;
        ...
        float color = ReflectionHacks.getPrivate(sb, SpriteBatch.class, "color");
        int idx = ReflectionHacks.getPrivate(sb, SpriteBatch.class, "idx");
        vertices[idx] = cx;
        vertices[idx + 1] = cy;
