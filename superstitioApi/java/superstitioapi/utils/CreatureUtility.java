...
public class CreatureUtility {
    ...
    public static AbstractCreature getTargetOrRandomMonster(AbstractCreature target) {
        if (isAlive(target)) {
            return target;
        }
    ...
    public static AbstractMonster getMonsterOrRandomMonster(AbstractCreature target) {
