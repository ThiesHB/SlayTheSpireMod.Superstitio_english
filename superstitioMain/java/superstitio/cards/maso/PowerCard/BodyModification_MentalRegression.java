...
@AutoAdd.Ignore
public class BodyModification_MentalRegression extends MasoCard {
    public static final String ID = DataManager.MakeTextID(BodyModification_MentalRegression.class);
    ...
    public static class BodyModification_MentalRegressionPower extends EasyBuildAbstractPowerForPowerCard {
        ...
        protected SuperstitioCard makePowerCard() {
            return new BodyModification_MentalRegression();
        }
    }
}
